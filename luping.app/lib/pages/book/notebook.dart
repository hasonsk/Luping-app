    ...
    final Book selectedBook = Book(
      ...
      lessons: [
        Lesson(
          ...
          vocabulary: [
            Word(id:1,word:'你',pinyin:'nǐ',meaning:['Bạn, cậu, anh,..'], hanviet: 'Chào bạn', cannghia: [], trainghia: [], image: null, shortmeaning: "Bạn", hskLevel: '1'),
            Word(id:2,word:'你好',pinyin:'nǐ hǎo',meaning:['Chào bạn, cậu, anh,..'], hanviet: 'Tôi', cannghia: [], trainghia: [], image: null, shortmeaning: "Chào bạn", hskLevel: '1'),
            Word(id:3,word:'好',pinyin:'hǎo',meaning:['Tốt, khỏe'], hanviet: 'Bạn', cannghia: [], trainghia: [], image: null, shortmeaning: "Tốt", hskLevel: '1'),
            Word(id:4,word:'好吗?',pinyin:'hǎo ma?',meaning:['Tốt không?'], hanviet: 'Bạn', cannghia: [], trainghia: [], image: null, shortmeaning: "Tốt không", hskLevel: '1'),
            Word(id:5,word:'不好。',pinyin:'bù hǎo.',meaning:['Không tốt.'], hanviet: 'Bạn', cannghia: [], trainghia: [], image: null, shortmeaning: "Không tốt", hskLevel: '1'),
            Word(id:6,word:'您',pinyin:'nín',meaning:['Ngài (Người lớn tuổi hơn)'], hanviet: 'Bạn', cannghia: [], trainghia: [], image: null, shortmeaning: "Ngài", hskLevel: '1'),
          ],
          kanji: [
            Word(id: 1, word: '你', pinyin: 'nǐ', meaning: ['Bạn'], hanviet: 'Bạn', cannghia: [], trainghia: [], image: null, shortmeaning: "Bạn", hskLevel: '1'),
            Word(id: 2, word: '好', pinyin: 'hǎo', meaning: ['Tốt'], hanviet: 'Tốt', cannghia: [], trainghia: [], image: null, shortmeaning: "Tốt", hskLevel: '1'),
          ],
        ...
        Lesson(
          ...
          vocabulary: [
            ...
            Word(id: 5, word: '不客气', pinyin: 'bú kèqì', meaning: ['Không có gì'], hanviet: 'Không có gì', cannghia: [], trainghia: [], image: null, shortmeaning: "Không có gí", hskLevel: '1'),
          ],
          kanji: [],
