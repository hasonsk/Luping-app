  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Chi tiết', style: TextStyle(fontSize: 18, color: Colors.grey[700])),
        centerTitle: true,
        toolbarHeight: 50,
                        ...
                        children: [
                                  ...
                                  Stack(
                                    children: [
                                      Container(
                                        decoration: const BoxDecoration(
                                          image: DecorationImage(
                                              image: AssetImage('assets/cardnai_bg_word.webp'),
                                              fit: BoxFit.cover),
                                        ),
                                        child: SizedBox(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      const SizedBox(
                                                        width: double.infinity,
                                                        height: 20, // Placeholder cho pinyin

                                                      ),
                                                      const SizedBox(height: 20),
                                                      const SizedBox(
                                                        width: 30,
                                                        height: 30, // Placeholder cho nút phát
                                                      ),
                                                      const SizedBox(height: 10)
                                                    ],
                                                  ),
                                      ...
                                      const Positioned(
                                        ...
                                        child: SizedBox(
                                          width: 50,
                                          height: 50, // Placeholder cho hình ảnh
                                        ),
                                      ),
                                      Positioned(
                                        left: 10,
                                        ...
                                        child: Container(
                                          width: 40,
                                          height: 55, // Placeholder cho bookmark
                                          decoration: const BoxDecoration(
                                            image: DecorationImage(
                                              image: AssetImage('assets/bookmark.webp'),
                                              fit: BoxFit.contain,
                                            ),
                                          ),
                                          child: const Column(
                                            ...
                                            children: [
                                              Text('HSK', style: TextStyle(fontSize: 12),),
                                              SizedBox(height: 5),
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              decoration: const BoxDecoration(
                                color: noteColor,
                                borderRadius: BorderRadius.all(Radius.circular(10)), // Thêm borderRadius
                              ),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                vidu(1, '我们的老师', 'wǒmen de lǎoshī', 'Thầy giáo của chúng tôi'),
                                vidu(2, '我们的学校真大，是吧？', 'wǒmen de xuéxiào zhēn dà, shì ba?', 'Trường của chúng mình thật to, phải không?'),
                              ],
                            ),
                          ),
                          const SizedBox(height: 20,),
                          const SectionHeader(text: 'Hình ảnh'),
                          const Center(child: Text('( 我们 )', style: TextStyle(fontSize: 12, color: Colors.green),)),
                          ...
                          Container(
                            ...
                            child: CarouselSlider.builder(
                              ...
                              options: CarouselOptions(
                                ...
                                aspectRatio: 16 / 9,
                                viewportFraction: 0.58, // Tăng kích cỡ của slide
                              ...
                              child : Column(
                                  ...
                                  children : [
                                    Container(
                                        ...
                                        child: const Text('Từ trái nghĩa :', style : TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.bold))
                                    ),
                                    Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: word.trainghia!.asMap().entries.map((entry) {
                                        int index = entry.key;
                                    ...
                                    Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: word.cannghia!.asMap().entries.map((entry) {
                                        int index = entry.key;
          ...
          children: [
            Container(
              ...
              child: Padding(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(12), // Đảm bảo ảnh cũng có góc bo tròn
                  child: Image.network(
                    imageUrl,
                    height: 80,
                    width: double.infinity,
    ...
    builder: (BuildContext context) {
      return Dialog(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(10.0), // Đặt bo tròn cho hộp thoại
        ),
        child: Stack(
          children: [
            Container(
              ...
              width: MediaQuery.of(context).size.width * 0.8, // Chiều rộng của Container (80% màn hình)
              child: Image.network(
                imageUrl,
                fit: BoxFit.contain,
              ),
            ...
            Positioned(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.of(context).pop(); // Đóng hộp thoại khi nhấn vào icon
                },
              ),
            ),
          ],
